          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-8 shadow-xl sticky top-8">
              ...
              <div className="mb-6 p-4 bg-slate-50 rounded-lg border border-slate-200">
                <p className="font-semibold text-slate-900 mb-3 text-center">
                  Compartir esta rifa
                </p>
                <div className="flex flex-wrap gap-2 justify-center">
                  <button
                    onClick={() => handleShare('facebook')}
                    className="flex items-center space-x-2 px-4 py-2 bg-[#1877F2] text-white rounded-lg hover:bg-[#166FE5] transition-all"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2 bg-[#1DA1F2] text-white rounded-lg hover:bg-[#1A8CD8] transition-all"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2 bg-[#25D366] text-white rounded-lg hover:bg-[#1EBE57] transition-all"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2 bg-[#0088cc] text-white rounded-lg hover:bg-[#0077b5] transition-all"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    className="flex items-center space-x-2 px-4 py-2 bg-slate-600 text-white rounded-lg hover:bg-slate-700 transition-all"
                  >
