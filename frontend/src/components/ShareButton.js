...
const ShareButton = ({ raffle, small = false }) => {
      ...
      <button
        ...
        className={`flex items-center space-x-1 ${
          small 
            ? 'px-3 py-1.5 text-sm' 
            : 'px-4 py-2'
        } bg-slate-100 text-slate-700 rounded-lg hover:bg-slate-200 transition-all`}
      >
        <Share2 className={small ? 'w-4 h-4' : 'w-5 h-5'} />
        <span>Compartir</span>
      </button>
          ...
          <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl border border-slate-200 z-20">
            <div className="p-2 space-y-1">
              <button
                ...
                className="w-full flex items-center space-x-2 px-3 py-2 hover:bg-slate-100 rounded-lg transition-colors text-left"
              >
              ...
              >
                ...
                <span className="text-slate-700">Copiar enlace</span>
              </button>
            </div>
          </div>
        </>
